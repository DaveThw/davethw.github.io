...
|          |         | 0-49      | *Blank*                                         |
|          |         |           | **_I'm not certain how to activate the following fuctions - you may need to hold for at least 3s, and also have Shutter Strobe channel (22/15) closed (DMX 0-31) at the same time, but I can't get it to work..._** |
...
|          |         |           | To activate the following fuctions, hold DMX value for at least 3 seconds: |
|          |         | 130-139   | Lamp On                           |
...
|          |         | 230-239   | Lamp Off                           |
|          |         | 240-255   | *Blank*                           |
|  7       | 5       |           | **Colour Wheel** *(Robe Colour Wheel 50)* |
...
|  11      | 8       |           | **Rotating Gobo Wheel:** *(Same as 'Robe Gobo Wheel 45')* |
|          |         |           | When changing to a value in the range of DMX 0-59 (Gobo Index or Rotate, without Shake) and DMX 244-255 (Random Gobo Selection) the gobo selection speed is controlled by the Effect Speed channel (9 / 6) |
|          |         |           | **Index - set index position with Gobo Index/Rotation channel (12 / 9):** - note: index doesn't always hit exactly the same position (if rotation has been used?)... |
|          |         | 0         | Open/Hole (default) |
|          |         | 1-4       | Hole (flat field) *(Generic 032 - Beam Flattener)* - doubles beam anlge? (and changes focus!) |
...
|          |         | 32-34     | Gobo 1 - Three Triangles *(Robe 276)* |
|          |         | 35-37     | Gobo 2 - 12 Spokes *(Robe 277)* |
|          |         | 38-40     | Gobo 3 - Three Dot Shadows *(Robe 278)* |
|          |         | 41-43     | Gobo 4 - 12-Pointed Linear Star *(Robe 279)* |
|          |         | 44-46     | Gobo 5 - Grid/Grill *(Robe 280)* |
|          |         | 47-49     | Gobo 6 - Lots and Lots of Small Dots *(Robe 281)* |
|          |         | 50-52     | Gobo 7 - 12-way Petals *(Robe 282)* |
|          |         | 53-55     | Gobo 8 - Lots of Dots (scattered - various sizes) *(Robe 283)* |
|          |         | 56-59     | Gobo 9 - Six-Blade Windmill *(Robe 284)* |
|          |         |           | **Index with Shake (slow->fast) - set index position with Gobo Index/Rotation channel (12 / 9):** |
|          |         | 60-67     | Gobo 1 - Three Triangles *(Robe 276)* |
|          |         | 68-75     | Gobo 2 - 12 Spokes *(Robe 277)* |
|          |         | 76-83     | Gobo 3 - Three Dot Shadows *(Robe 278)* |
|          |         | 84-91     | Gobo 4 - 12-Pointed Linear Star *(Robe 279)* |
|          |         | 92-99     | Gobo 5 - Grid/Grill *(Robe 280)* |
|          |         | 100-107   | Gobo 6 - Lots and Lots of Small Dots *(Robe 281)* |
|          |         | 108-115   | Gobo 7 - 12-way Petals *(Robe 282)* |
|          |         | 116-123   | Gobo 8 - Lots of Dots (scattered - various sizes) *(Robe 283)* |
|          |         | 124-129   | Gobo 9 - Six-Blade Windmill *(Robe 284)* |
|          |         |           | **Rotate with Shake (slow->fast) - set rotation speed with Gobo Index/Rotation channel (12 / 9):** |
|          |         | 130-137   | Gobo 1 - Three Triangles *(Robe 276)* |
|          |         | 138-145   | Gobo 2 - 12 Spokes *(Robe 277)* |
|          |         | 146-153   | Gobo 3 - Three Dot Shadows *(Robe 278)* |
|          |         | 154-161   | Gobo 4 - 12-Pointed Linear Star *(Robe 279)* |
|          |         | 162-169   | Gobo 5 - Grid/Grill *(Robe 280)* |
|          |         | 170-177   | Gobo 6 - Lots and Lots of Small Dots *(Robe 281)* |
|          |         | 178-185   | Gobo 7 - 12-way Petals *(Robe 282)* |
|          |         | 186-193   | Gobo 8 - Lots of Dots (scattered - various sizes) *(Robe 283)* |
|          |         | 194-199   | Gobo 9 - Six-Blade Windmill *(Robe 284)* |
...
|          |         | 244-249   | Random Indexed Gobo Selection (auto: fast->slow) |
|          |         | 250-255   | Random Indexed Gobo Selection (auto: fast->slow) |
|  12      | 9       |           | **Rotating Gobo Index / Rotation** |
|          |         |           | **Gobo Index - select gobo with Rotating Gobo Wheel channel (11 / 8):** |
|          |         | 0-255     | Index (0 - ~360deg) - note: index doesn't always hit exactly the same position (if rotation has been used?)... |
...
|          |         |           | *Note: slight difference in the boundary of the ranges here - the manual (for both Viking and Robin units) says 76-**105** / **106**-127, but my experience says 76-**104** / **105**-127!* |
...
|          |         | 0-255     | Index (0 - ~390deg) - note: index doesn't always hit exactly the same position (if rotation has been used?)... |
...
|          |         | 0-64      | No Frost |
|          |         |           | *(Note: When the frost is activated, both gobo wheels return to 'open', and Zoom and Focus seem to have no effect)* |
